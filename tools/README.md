...
| [`region-render`](region-render/)        | Rust   | 0.4.0   | Render a region GFF's full visual stack: background tiles, walls, and entity sprites into a 2048x1568 palette-indexed PNG. v0.4.0 adds `--palette-preset {ds1-pink, ds1-rust, ds1-deep-red}` for one-knob DS1 palette switching. Per-region DS1 palette selection and animated colours still need DSUN.EXE RE.|
